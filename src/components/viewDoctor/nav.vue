            ...
            <div class="container">
                <div class="row p-2 mt-3">
                    ...
                    <div class="col-lg-4 col-md-4 d-none d-lg-block d-lg-block p-2 d-lg-flex">
                        <img src="https://via.placeholder.com/250x250" alt="" class="mx-auto d-none d-lg-block" style="max-width:250px; max-height: 250px">
                    </div>
                    <div class="offset-lg-0 col-lg-3 col-md-4 p-2 d-flex flex-column justify-content-end nav-group">
                        <img src="https://via.placeholder.com/120" alt="" class="mx-auto">
...
export default {
    ...
    beforeCreate(){
        ...
        const requestPath = `/doctor/${session.userId}`;
