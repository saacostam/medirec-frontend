            ...
            <div class="container">
                <div class="row  p-2">
                    <div class="col-lg-5 p-5">
                        <img src="/static/img/antecedentesFamiliaresIcon.png" class="img-fluid img-button">
                        <div>
                        ...
                        <div v-else>
                            <div class="card message">
                                <div class="card-body offset-lg-2 col-lg-8">
                                    <h5 class="card-title text-center">El paciente tiene <b class="text-color-main-dark">0</b> antecedentes familiares registrados.</h5>
                                </div>
                            </div>
                        </div>
                    </div>
