            ...
            <div class="container">
                <div class="row  p-2">
                    <div class="col-lg-5 p-5">
                        <img src="../../../../public/static/img/enfermedadesIcon.png" class="img-fluid img-button">
                        <div>
                            <h4 class="name bg-color-main-light text-white">Enfermedades</h4>
                        </div>
                    </div>
                    <div class="col-lg-7 p-5">
                        ...
                        <table class="table" v-if="this.illnesses.length>0">
                            ...
                            <tbody>
                                <tr v-for="illness in this.illnesses" :key="illness.illnessName">
                        ...
                        <div v-else>
                            <div class="card message">
                                <div class="card-body offset-lg-2 col-lg-8">
                                    <h5 class="card-title text-center">El paciente tiene <b class="text-color-main-dark">0</b> enfermedades registradas.</h5>
                                </div>
                            </div>
                        </div>
                    </div>
