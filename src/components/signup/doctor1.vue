                ...
                <div class="offset-2 col-8">
                  ...
                  <div class="form-group mb-4">
                      <div class="input-group">
                        ...
                        <input v-model="doc" type="number" class="form-control bg-color-main-lighter border-0" placeholder="Documento" required min="10000" max="9999999999">
                  ...
                  <div class="form-group">
                      <div class="input-group">
                          <div class="input-group-prepend">
                              <div class="input-group-text bg-color-main-dark border-0 text-white">
                              <img src="/static/svg/card-list.svg" class="password" width="16" height="16" viewBox="0 0 16 16">
                              </div>
                          </div>
