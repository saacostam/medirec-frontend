<template>
    <div class="my-requests container">
        <div class="row">
            <div class="col-lg-6">
                <img src="../../../public/static/img/myRequestIcon.jpg" class="img-fluid">
            </div>
                ...
                <div class="list" v-else>
                    <div class="result d-flex flex-row" v-for="doctor in this.doctors" :key="doctor.id">
                        ...
                        <div class="buttons-nav p-3 d-flex flex-column justify-content-center">
                            <img src="../../../public/static/img/checkIcon.png" width="50px" height="50px" class="m-1 rounded rounded-circle div-option" @click="accept(doctor.id)">
                            <img src="../../../public/static/img/deniedIcon.png" width="50px" height="50px" class="m-1 rounded rounded-circle div-option" @click="decline(doctor.id)">
                        </div>
                    </div>
                </div>
            </div>
